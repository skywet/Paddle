...
class _DenseLayer(nn.Layer):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate=None):
        ...
        if self.drop_rate:
            self.dropout_func = nn.Dropout(p=self.drop_rate, mode="downscale_in_infer")
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.conv_ac_func = BNConvLayer(num_input_features=num_input_features, num_filters=num_output_features, filter_size=1, pad=0, stride=1)
